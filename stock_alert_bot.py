...
Original file is located at
    https://colab.research.google.com/drive/1Heolxw67MC-xFHyOzS_-sOK7MjpdBqpY
"""
...
def send_discord(message):
    if "여기에" in WEBHOOK_URL:
        print("⚠️ WEBHOOK_URL 넣어줘.")
        return
...
for ticker, name in TICKERS.items():
    ...
    indicator_df, signal_df = calculate_signals(df)
